...
<H1>This application leverages:</H1>
...
<H1>After Installation:</H1>
  &emsp;After running <ins>docker-compose up</ins> in terminal, both frontend and backend will spool up and initialize. Both frontend and backend will automatically install required libraries and dependencies. </br> 
